...
def main():
    ...
    parser.add_argument('-output_path', type=str, help='Directory to save the output')
    parser.add_argument('-domain', type=str)
    parser.add_argument('-task', type=str)
    parser.add_argument('-instruction_type', type=str)
    parser.add_argument('-prompt_setting', type=str)
    ...
    if args.domain not in all_scores:
        all_scores[args.domain] = {}
    if args.task not in all_scores[args.domain]:
        all_scores[args.domain][args.task] = {}
    if args.instruction_type not in all_scores[args.domain][args.task]:
        all_scores[args.domain][args.task][args.instruction_type] = {}
